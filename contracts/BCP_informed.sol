...
interface BCP_interface {
    function ORDER(int64 commitmentID, uint40 gasForMailbox, string calldata location, uint32 orderDate, uint64 gasPriceInGwei) external payable returns(uint32 orderID);      
